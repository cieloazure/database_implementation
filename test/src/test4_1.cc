...
void q2() {
  ...
  if (fabs(result - 1500000) > 0.1) cout << "error in estimating Q2\n";
...
void q3() {
  ...
  if (fabs(result - 60000000.0) > 0.1) cout << "error in estimating Q3\n";
...
void q5() {
  ...
  if (fabs(result - 400081) > 0.1) cout << "error in estimating Q5\n";
...
void q6() {
  ...
  if (fabs(result - 32000) > 0.1) cout << "error in estimating Q6\n";
  s.Apply(final, relName, 3);
...
void q7() {
  ...
  if (fabs(result - 2000405) > 0.1) cout << "error in estimating Q7\n";
...
void q9() {
  ...
  double result = s.Estimate(final, relName, 3);
  if (fabs(result - 4) > 0.5) cout << "error in estimating Q9\n";
...
void q10() {
  ...
  if (fabs(result - 2000405) > 0.1) cout << "error in estimating Q10\n";
