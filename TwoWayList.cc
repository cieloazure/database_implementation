...
template <class Type> TwoWayList<Type>::TwoWayList(TwoWayList &me) {
...
template <class Type> TwoWayList<Type>::TwoWayList() {
...
template <class Type> Type *TwoWayList<Type>::Current(int offset) {
